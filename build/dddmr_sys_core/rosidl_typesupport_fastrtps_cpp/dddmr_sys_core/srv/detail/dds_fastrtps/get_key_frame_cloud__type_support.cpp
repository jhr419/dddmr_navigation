...
#include "dddmr_sys_core/srv/detail/get_key_frame_cloud__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dddmr_sys_core::srv::GetKeyFrameCloud_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dddmr_sys_core::srv::GetKeyFrameCloud_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dddmr_sys_core::srv::GetKeyFrameCloud_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetKeyFrameCloud_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dddmr_sys_core::srv::GetKeyFrameCloud_Request *>(
...
static size_t _GetKeyFrameCloud_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetKeyFrameCloud_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetKeyFrameCloud_Request__callbacks = {
  "dddmr_sys_core::srv",
...
static rosidl_message_type_support_t _GetKeyFrameCloud_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetKeyFrameCloud_Request__callbacks,
...
{
  return &dddmr_sys_core::srv::typesupport_fastrtps_cpp::_GetKeyFrameCloud_Request__handle;
}
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  sensor_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.key_frame_ground,
    cdr);
  // Member: key_frame_ground_edge
  sensor_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.key_frame_ground_edge,
    cdr);
  return true;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dddmr_sys_core::srv::GetKeyFrameCloud_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dddmr_sys_core::srv::GetKeyFrameCloud_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dddmr_sys_core::srv::GetKeyFrameCloud_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetKeyFrameCloud_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dddmr_sys_core::srv::GetKeyFrameCloud_Response *>(
...
static size_t _GetKeyFrameCloud_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetKeyFrameCloud_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetKeyFrameCloud_Response__callbacks = {
  "dddmr_sys_core::srv",
...
static rosidl_message_type_support_t _GetKeyFrameCloud_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetKeyFrameCloud_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &dddmr_sys_core::srv::typesupport_fastrtps_cpp::_GetKeyFrameCloud_Response__handle;
}
...
static service_type_support_callbacks_t _GetKeyFrameCloud__callbacks = {
  "dddmr_sys_core::srv",
  "GetKeyFrameCloud",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dddmr_sys_core, srv, GetKeyFrameCloud_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dddmr_sys_core, srv, GetKeyFrameCloud_Response)(),
...
static rosidl_service_type_support_t _GetKeyFrameCloud__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetKeyFrameCloud__callbacks,
...
{
  return &dddmr_sys_core::srv::typesupport_fastrtps_cpp::_GetKeyFrameCloud__handle;
}
