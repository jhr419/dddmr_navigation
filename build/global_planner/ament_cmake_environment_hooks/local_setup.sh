...
: ${AMENT_CURRENT_PREFIX:="/root/dddmr_navigation/install/global_planner"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/global_planner/environment/library_path.sh"
