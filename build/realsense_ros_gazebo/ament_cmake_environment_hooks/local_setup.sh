...
: ${AMENT_CURRENT_PREFIX:="/ws_gz/install/realsense_ros_gazebo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/realsense_ros_gazebo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/realsense_ros_gazebo/environment/path.sh"
