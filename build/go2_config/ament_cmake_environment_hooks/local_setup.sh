...
: ${AMENT_CURRENT_PREFIX:="/ws_gz/install/go2_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_config/environment/pythonpath.sh"
